...
gulp.task("copyStatic", function() {
    gulp
        ...
        .pipe(rename("6058_Yahoo_TruStage_RTB_Brand_Messaging_Animated_300x50_STATIC.jpg"))
...
gulp.task(
    ...
    function() {
        return gulp
            .src(dist + "/*")
            .pipe(zip("6058_Yahoo_TruStage_RTB_Brand_Messaging_Animated_300x50_HTML.zip"))
            .pipe(gulp.dest("../HTML/"));
    }
);