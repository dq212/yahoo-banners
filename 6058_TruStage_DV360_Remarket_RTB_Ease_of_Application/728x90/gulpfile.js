...
gulp.task("copyStatic", function() {
    gulp
        ...
        .pipe(rename("6058_Yahoo_TruStage_RTB_Ease_of_Application_Animated_728x90_STATIC.jpg"))
...
gulp.task(
    ...
    function() {
        return gulp
            .src(dist + "/*")
            .pipe(zip("6058_Yahoo_TruStage_RTB_Ease_of_Application_Animated_728x90_HTML.zip"))
            .pipe(gulp.dest("../HTML/"));
    }
);